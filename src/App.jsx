...
const SEED_AGENTS = [
  ...
  { id: '23', name: "Celestial Destiny Agent OS", description: "Packaged Cowork agent that acts as the marketing team for destinyrealm.com — drafts on-brand Pinterest/Instagram pin images and matching captions for approval before posting.", status: "paused", category: "Content Automation / Marketing Agent", techStack: ["Claude Code / Cowork agent skill (CLAUDE.md + .claude/skills)", "Markdown context files", "Python 3 + Pillow"], apis: ["Higgsfield MCP (suggested, not wired)", "Metricool / Meta Business Suite (suggested, not wired)"], hosting: "Local", url: "https://destinyrealm.com", repoUrl: "", deployMethod: "Manual (install folder into Cowork, run the celestial-pins skill)", folder: "D:/celestial-agents/Celestial-Destiny-OS", notes: "A real packaged agent, not a script: CLAUDE.md as northstar, /context for brand facts, a self-updating memory.md, and generate_pins.py rendering 1000×1500 pins from the actual card art. Golden rule is baked in — the agent drafts and queues, I approve, nothing goes live unattended. Never run in anger: no /output folder yet, two context files still stubs. Untouched since 2026-08-03." },
